/*
  A insígnia da vereda CC-ES001 Arquivos e Armazenamento.
  ...
  `cc-es001` vira `cces001`. A linha na tabela, não — ela continua sendo à mão,
  ...
  O normal é `supabase/` antes e a tela depois, e as outras veredas seguiram
  isso. Aqui não dá: `estante.test.ts` cobra que toda insígnia semeada no banco
  tenha lugar na estante, e o lugar da vereda sai de `veredasAbertas()` —
  semear a linha com a vereda ainda `emConstrucao` reprova ali, e com razão.
...
INSERT INTO badges (code, name, description, icon, tier, sort_order) VALUES
  ('vereda_cces001', 'Vereda CC-ES001 Arquivos e Armazenamento',
   'Percorreu a vereda CC-ES001 Arquivos e Armazenamento até o fim.',
   'route', 'excursionista', 134)
