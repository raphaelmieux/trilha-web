...
const rawQuestions_L1: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Um serviço mantido por uma grande empresa, que reúne num só lugar tudo o que se acessa.', porque: 'Nenhuma empresa é dona da Internet. Ela é uma rede de redes, sem centro e sem proprietário.' },
      { id: 'c', text: 'O programa instalado no computador que abre as páginas e permite ir de uma a outra.', porque: 'Isso é o navegador. Ele é a janela; a Internet é a rede que existe do outro lado dela.' },
      { id: 'd', text: 'O conjunto de cabos e antenas por onde os dados viajam entre as cidades.', porque: 'Os cabos são o meio físico. A Internet é o que acontece sobre eles: máquinas conversando por regras comuns.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'São a mesma coisa: dois nomes para a mesma rede, um mais técnico e outro mais popular.', porque: 'São camadas diferentes. E-mail e streaming usam a Internet sem passarem pela Web.' },
      { id: 'c', text: 'A Internet é o que a operadora entrega em casa, e a WWW é o programa que abre as páginas.', porque: 'A operadora entrega o acesso, não a Internet em si — e quem abre as páginas é o navegador, não a WWW.' },
      { id: 'd', text: 'A WWW é uma parte mais nova e mais rápida da Internet, reservada às páginas.', porque: 'A Web não é uma parte mais rápida: é um serviço que roda sobre a Internet, como o e-mail.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Falso', porque: 'Foi sim. Berners-Lee propôs a Web no CERN em 1989. Quem confunde costuma pensar na ARPANET, de 1969 — essa é a rede, não a Web.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'HTML', porque: 'HTML é a linguagem que descreve como uma página se apresenta. Ele não move dados entre máquinas.' },
      { id: 'c', text: 'POP3', porque: 'POP3 é um protocolo de e-mail: serve para buscar mensagens num servidor, não para a comunicação geral da rede.' },
      { id: 'd', text: 'JPEG', porque: 'JPEG é um formato de imagem. Ele diz como guardar uma foto, não como dois computadores conversam.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Porque cada pessoa mantém em casa o próprio servidor, guardando ali os seus dados e os de quem se conecta a ela.', porque: 'Quase ninguém mantém servidor em casa. O que descentraliza a rede é não existir um centro obrigatório, e não cada um ter o seu.' },
      { id: 'c', text: 'Porque a Internet dispensa servidores: os aparelhos conversam direto.', porque: 'Servidores existem, e muitos. Descentralizar não é dispensá-los: é não depender de um só.' },
      { id: 'd', text: 'Porque uma única empresa controla a rede inteira e decide o que circula.', porque: 'Isso descreveria o oposto: uma rede centralizada. Nenhuma empresa é dona da Internet.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Ele está certo: os dois termos nomeiam exatamente a mesma tecnologia.', porque: 'Ele não está. E-mail e streaming usam a Internet sem passar pela Web — prova de que são coisas distintas.' },
      { id: 'c', text: 'A Web é a infraestrutura de cabos e antenas, e a Internet é apenas um dos serviços que funcionam em cima dessa estrutura.', porque: 'Está invertido. A infraestrutura é a Internet; a Web é um dos serviços que rodam sobre ela.' },
      { id: 'd', text: 'Nenhum dos dois tem relação: foram criados por equipes independentes.', porque: 'Têm, e muita: a Web foi criada para funcionar em cima da Internet, e não existe sem ela.' },
    ]},
...
const rawQuestions_L2: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'c', text: 'Apagar um arquivo do computador para liberar espaço em disco.', porque: 'Apagar não transfere nada. Download é trazer um arquivo de outro computador para o seu.' },
      { id: 'd', text: 'Compartilhar um arquivo anexando-o a uma mensagem de e-mail.', porque: 'Anexar envia o arquivo para longe de você. Quem baixa é quem recebe a mensagem.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Baixar um arquivo da Internet para guardá-lo no seu aparelho.', porque: 'Isso é download. Upload é a direção oposta: do seu aparelho para o servidor.' },
      { id: 'c', text: 'Formatar o disco rígido antes de gravar arquivos novos.', porque: 'Formatar apaga o que está no disco. Não envia nada para lugar nenhum.' },
      { id: 'd', text: 'Atualizar o sistema operacional para a versão mais recente.', porque: 'Atualizar é, na prática, um download: os arquivos novos vêm até você.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      { id: 'a', text: 'Verdadeiro', porque: 'É o contrário. Assistir é receber: o vídeo desce do servidor para o seu aparelho, portanto é download.' },
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Download, porque a foto sai do aplicativo e chega ao seu aparelho.', porque: 'A foto já estava no seu telefone. Publicar é mandá-la para fora, o que é upload.' },
      { id: 'c', text: 'Nenhum dos dois, porque a foto continua guardada só no seu telefone.', porque: 'Se a foto aparece para outras pessoas, ela saiu do seu telefone. Essa saída é a transferência.' },
      { id: 'd', text: 'Os dois ao mesmo tempo, embora só o download entre na conta de dados que a operadora cobra ao fim do mês.', porque: 'Publicar é envio. Você só baixaria algo ao abrir o aplicativo e ver fotos dos outros.' },
    ]},
...
const rawQuestions_L3: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Uma única página publicada na Internet, com endereço próprio e conteúdo independente.', porque: 'Isso é uma página. O site é o conjunto delas, ligadas entre si sob o mesmo endereço.' },
      { id: 'c', text: 'O endereço que se digita na barra do navegador para chegar a um conteúdo.', porque: 'Isso é a URL, o endereço. O site é o que se encontra ao seguir esse endereço.' },
      { id: 'd', text: 'O computador ligado o tempo todo que guarda as páginas e as entrega a quem pede.', porque: 'Isso é o servidor. Ele hospeda o site, mas não é o site.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'O endereço pessoal, no formato nome@provedor, usado para receber mensagens.', porque: 'Isso é o endereço de e-mail. O e-mail é o sistema inteiro que leva a mensagem até ele.' },
      { id: 'c', text: 'O programa instalado no computador que abre e organiza as mensagens recebidas.', porque: 'Isso é o cliente de e-mail. Ele lê as mensagens; o e-mail é o serviço que as transporta.' },
      { id: 'd', text: 'A troca instantânea de mensagens curtas, com as duas pessoas conectadas ao mesmo tempo.', porque: 'Isso descreve mensagem instantânea. O e-mail não exige que quem recebe esteja conectado.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Malware é o nome do programa de proteção instalado na máquina, e vírus é o software que tenta contornar essa proteção.', porque: 'Está invertido. Malware é o software que ataca; o que protege é o antivírus.' },
      { id: 'c', text: 'São exatamente a mesma coisa: dois nomes para o mesmo problema.', porque: 'Não são: todo vírus é malware, mas nem todo malware é vírus. Worm e ransomware também são malware.' },
      { id: 'd', text: 'Vírus atinge somente mensagens de e-mail e malware somente sites visitados.', porque: 'Nenhum dos dois se limita a um canal. Vírus e malware chegam por download, pendrive, anexo ou site.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      { id: 'a', text: 'Verdadeiro', correct: true },
      { id: 'b', text: 'Falso', porque: 'Precisa sim. Sem um servidor ligado guardando as páginas, não há de onde o navegador buscá-las.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Spyware — apenas espia sua atividade.', porque: 'Spyware observa e envia o que você faz, em silêncio. Aqui os arquivos foram trancados e houve cobrança — isso é resgate.' },
      { id: 'c', text: 'Vírus, porque se replica dentro de arquivos executáveis já existentes.', porque: 'Vírus se copia para dentro de outros arquivos. Este não se espalhou: trancou o que já existia e pediu pagamento.' },
...
const rawQuestions_2L1: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'IMAP', porque: 'IMAP faz o contrário: deixa as mensagens no servidor para que todos os aparelhos vejam as mesmas.' },
      { id: 'c', text: 'HTTP', porque: 'HTTP é o protocolo das páginas web. Ele não busca e-mail em servidor de correio.' },
      { id: 'd', text: 'SMTP', porque: 'SMTP é o caminho de saída: serve para enviar mensagens, não para buscá-las.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'É mais rápido para enviar mensagens, porque mantém a conexão aberta o tempo todo com o servidor.', porque: 'Nenhum dos dois envia mensagens — quem envia é o SMTP. IMAP e POP3 servem para receber.' },
      { id: 'c', text: 'Dispensa senha, porque a autenticação fica salva no próprio servidor.', porque: 'IMAP exige senha como qualquer outro. Guardar a senha no aparelho é comodidade do programa, não do protocolo.' },
      { id: 'd', text: 'Compacta os anexos sozinho, poupando espaço na caixa de entrada.', porque: 'Nenhum dos dois mexe no tamanho dos anexos. A vantagem do IMAP é manter tudo sincronizado.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'c', text: 'IMAP', porque: 'IMAP também é de recebimento. Ele sincroniza o que já chegou, não envia nada.' },
      { id: 'd', text: 'FTP', porque: 'FTP transfere arquivos entre computadores. Não tem relação com correio eletrônico.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      { id: 'a', text: 'Verdadeiro', correct: true },
      { id: 'b', text: 'Falso', porque: 'Permite sim. O webmail roda dentro do navegador — é por isso que dá para ler e-mail em qualquer computador emprestado.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'POP3 — baixa e remove do servidor, então cada dispositivo tem sua própria cópia.', porque: 'Justamente o que não se quer aqui: o POP3 leva a mensagem para um aparelho só, e o outro fica sem ela.' },
      { id: 'c', text: 'SMTP — é o protocolo de envio, não de recebimento.', porque: 'SMTP serve para enviar. A pergunta é sobre ler as mensagens que chegam.' },
      { id: 'd', text: 'HTTP — é o protocolo da web, não de e-mail.', porque: 'HTTP é o protocolo das páginas. Ele carrega o webmail na tela, mas não é ele quem sincroniza as mensagens.' },
    ]},
...
const rawQuestions_2L2: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'O serviço que encontra páginas na web a partir das palavras que a pessoa digita.', porque: 'Isso é o buscador, como o Google. Ele indica onde estão as páginas; o navegador é quem as abre.' },
      { id: 'c', text: 'A empresa que fornece a conexão e por onde passa todo o tráfego da casa.', porque: 'Isso é o provedor. Ele leva os dados até você; o navegador é o programa que os exibe.' },
      { id: 'd', text: 'O endereço digitado na barra superior para chegar a uma página específica.', porque: 'Isso é a URL. Ela diz para onde ir; o navegador é o que faz a viagem.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Baixar o arquivo inteiro no aparelho antes de poder começar a assistir, o que exige espaço livre igual ao tamanho do vídeo.', porque: 'Isso é download comum, e é o oposto de streaming: no streaming você assiste enquanto o vídeo ainda está chegando.' },
      { id: 'c', text: 'Um tipo de vírus que contamina arquivos de música e de vídeo.', porque: 'Streaming é uma forma de entregar mídia, não uma ameaça. Netflix e YouTube funcionam assim.' },
      { id: 'd', text: 'Um formato de compactação que reduz o tamanho de imagens e vídeos.', porque: 'Compactação encolhe o arquivo. Streaming é sobre como ele chega até você: aos poucos, enquanto toca.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'O programa instalado no aparelho que abre e exibe as páginas encontradas.', porque: 'Isso é o navegador. Buscador e navegador são coisas diferentes: um encontra, o outro abre.' },
      ...
      { id: 'd', text: 'A página que se abre sozinha assim que o navegador é iniciado.', porque: 'Isso é a página inicial. Ela até pode ser um buscador, mas abrir primeiro não é o que define um.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Porque a versão antiga deixa de funcionar depois de certo tempo e precisa ser renovada.', porque: 'O antivírus antigo continua funcionando. O que falta a ele é reconhecer o que surgiu depois.' },
      { id: 'c', text: 'Porque a atualização, sozinha, apaga os vírus que já estavam na máquina antes.', porque: 'Atualizar traz o conhecimento das ameaças novas; retirar as que já estão exige uma verificação.' },
      { id: 'd', text: 'Porque cada atualização substitui o antivírus por um programa diferente e melhor.', porque: 'A atualização renova a lista de ameaças conhecidas, não troca o programa.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      { id: 'a', text: 'Verdadeiro', porque: 'Não exige. É exatamente o contrário: o streaming começa a tocar com os primeiros pedaços, enquanto o resto ainda vem.' },
      { id: 'b', text: 'Falso', correct: true },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Perguntar num grupo de mensagens e usar o que os colegas lembrarem sobre o assunto.', porque: 'Serve para tirar uma dúvida rápida, mas não dá fonte para citar num trabalho escolar.' },
      { id: 'c', text: 'Abrir um site que você já conhece e procurar o assunto dentro dele.', porque: 'Funciona se aquele site tratar do tema. O buscador procura em toda a web de uma vez.' },
      { id: 'd', text: 'Digitar o endereço de um site sobre planetas que você imagina que exista.', porque: 'Chutar endereços quase nunca chega a lugar algum. É justamente para isso que existe o buscador.' },
    ]},
...
const rawQuestions_3L1: Question[] = [
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Tim Berners-Lee', porque: 'Berners-Lee criou a Web, em 1989. O TCP/IP é anterior e resolve outro problema: fazer redes diferentes se entenderem.' },
      { id: 'c', text: 'Larry Page e Sergey Brin', porque: 'Page e Brin fundaram o Google, em 1998 — quase vinte anos depois do TCP/IP já estar em uso.' },
      { id: 'd', text: 'Marc Andreessen', porque: 'Andreessen esteve no Mosaic, o primeiro navegador gráfico popular. Navegador é programa; TCP/IP é protocolo.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Google Chrome (2008)', porque: 'O Chrome é de 2008 e chegou quando a web já tinha quinze anos de navegadores gráficos.' },
      { id: 'c', text: 'Internet Explorer (1995)', porque: 'O Explorer veio em 1995, depois do Mosaic. Ele dominou o mercado, mas não foi o primeiro.' },
      { id: 'd', text: 'Firefox (2004)', porque: 'O Firefox é de 2004, herdeiro do Netscape — que por sua vez veio depois do Mosaic.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      { id: 'a', text: 'Verdadeiro', porque: 'É o contrário. A ARPANET é de 1969 e a Web de 1989: vinte anos separam a rede do serviço que roda nela.' },
      { id: 'b', text: 'Falso', correct: true },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Está correto: as duas foram criadas na mesma época, pela mesma equipe e para resolver o mesmo problema de comunicação.', porque: 'Não está. Vinte anos separam as duas: a ARPANET é de 1969 e a Web, de 1989.' },
      { id: 'c', text: 'A Web veio primeiro, e a Internet surgiu depois para dar suporte a ela.', porque: 'A ordem está invertida. A rede tinha de existir antes para que a Web pudesse funcionar sobre ela.' },
...
const rawQuestions_4L1: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Apenas navegando em sites conhecidos e de aparência confiável.', porque: 'Site conhecido também pode ser invadido e passar a distribuir arquivo infectado. E não é a única porta de entrada.' },
      { id: 'c', text: 'Desligando o computador à noite, já que nenhum programa consegue se instalar com a máquina fora da tomada.', porque: 'Desligar não é uma forma de receber ameaça — é o oposto. A pergunta é por onde elas chegam.' },
      { id: 'd', text: 'Usando senhas longas, que impedem qualquer programa de entrar.', porque: 'Senha longa protege a conta, e é boa prática. Mas não impede um anexo infectado de ser aberto.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Para melhorar a velocidade da Internet, que vai caindo conforme o antivírus acumula registros de verificação.', porque: 'Antivírus não mexe na velocidade da conexão. O que a atualização traz é o reconhecimento de ameaças novas.' },
      { id: 'c', text: 'Para liberar espaço no disco ocupado pela base antiga de ameaças.', porque: 'A base de ameaças cresce com a atualização, não encolhe. Espaço em disco não é o motivo.' },
      { id: 'd', text: 'Para atualizar o navegador junto com o restante do sistema.', porque: 'São programas independentes. Atualizar o antivírus não mexe no navegador.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Desligando-se sozinho sempre que a máquina fica ociosa.', porque: 'Máquina desligada não espalha nada. Vírus quer o computador ligado e em rede.' },
      { id: 'c', text: 'Formatando o disco rígido assim que o computador é ligado.', porque: 'Formatar destruiria o próprio vírus junto. Ele precisa continuar existindo para se espalhar.' },
      { id: 'd', text: 'Aumentando o volume do som, abrindo janelas de propaganda e trocando a página inicial do navegador sozinho.', porque: 'Isso incomoda quem usa a máquina, mas não leva o vírus a outro computador. Disseminar é chegar aos outros.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Apenas melhoria de desempenho, já que o vírus organiza os arquivos.', porque: 'Vírus consome memória e processamento para o que ele quer fazer. A máquina fica mais lenta, não mais rápida.' },
      { id: 'c', text: 'Aumento da velocidade da Internet, já que o vírus encerra os programas em segundo plano para usar a máquina.', porque: 'Muitos vírus usam a conexão para enviar dados sem você saber, o que deixa a Internet mais lenta.' },
      { id: 'd', text: 'Nenhum prejuízo real, porque os antivírus atuais bloqueiam tudo sozinhos.', porque: 'Antivírus ajuda muito, mas não pega tudo — sobretudo ameaças recentes. Por isso o cuidado de quem usa continua importando.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Clicar e digitar a senha, já que a mensagem tem a aparência de oficial.', porque: 'A aparência oficial é justamente o que se copia num golpe. Logotipo e endereço parecidos custam pouco a quem aplica.' },
      { id: 'c', text: 'Responder ao remetente informando a senha, para que o problema seja resolvido antes que a conta seja mesmo bloqueada.', porque: 'Banco nenhum pede senha, por e-mail ou por qualquer outro meio. Responder entrega a senha a quem escreveu.' },
      { id: 'd', text: 'Encaminhar aos amigos para que eles confiram se receberam o mesmo aviso.', porque: 'Espalha o link do golpe. Se quiser avisar alguém, conte o que houve — sem repassar a mensagem.' },
    ]},
...
const rawQuestions_5L0: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Bloquear páginas de conteúdo adulto.', porque: 'Isso o filtro faz, e é o principal uso dele. A pergunta é pelo que escapa: o que acontece dentro de uma conversa.' },
      { id: 'c', text: 'Desligar a internet da casa inteira depois de um horário combinado entre todos.', porque: 'Isso o filtro faz por horário, e muitos roteadores já trazem o recurso pronto.' },
      { id: 'd', text: 'Impedir a instalação de programas sem autorização.', porque: 'Isso o controle parental faz. O que nenhum programa lê é a intenção de quem escreve do outro lado.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Porque os roteadores domésticos não costumam oferecer esse tipo de recurso de fábrica.', porque: 'Muitos oferecem, e funcionam bem. O problema não é o roteador: é o alcance dele terminar na porta de casa.' },
      { id: 'c', text: 'Porque o filtro torna a conexão mais lenta para toda a casa.', porque: 'O efeito na velocidade é pequeno e não é o motivo. O ponto é que o celular sai de casa e sai do filtro junto.' },
      { id: 'd', text: 'Porque o recurso só funciona em computadores de modelos antigos.', porque: 'O filtro do roteador vale para tudo que se conecte por aquele Wi-Fi, inclusive celular e televisão.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'O pacto passa a substituir o filtro assim que a criança cresce.', porque: 'Não é uma coisa depois da outra. Conforme a criança cresce o filtro pesa menos e a conversa pesa mais, mas os dois convivem.' },
      { id: 'c', text: 'São a mesma coisa, apenas com nomes diferentes conforme o aparelho.', porque: 'São bem diferentes: o filtro é técnico e age sozinho; o pacto é um acordo entre pessoas, e depende de conversa.' },
      { id: 'd', text: 'O filtro só entra em vigor depois que o pacto tiver sido assinado e registrado em cartório.', porque: 'Filtro é configuração de aparelho — funciona assim que ligado. O pacto não é documento jurídico nem precisa de cartório.' },
    ]},
...
export const ap034: Specialty = {
  ...
  modules: [
    ...
    },
    {
      ...
      lessons: [
        { code: 'AP034.6-L1', title: 'Navegando e pesquisando com cuidado', type: 'lab', content: content_6L1, requirementCodes: ['AP034-6.1', 'AP034-6.2', 'AP034-6.3'], labType: 'web_lab' },
      ],
    },
    {
      ...
      lessons: [
        { code: 'AP034.7-L1', title: 'Escrevendo e-mails e reconhecendo golpes', type: 'lab', content: content_7L1, requirementCodes: ['AP034-7.1', 'AP034-7.2', 'AP034-7.3', 'AP034-7.4'], labType: 'mail_lab' },
      ],
    },
    {
      ...
      lessons: [
        { code: 'AP034.8-L1', title: 'Aplicando o filtro de Filipenses 4:8', type: 'lab', content: content_8L1, requirementCodes: ['AP034-8.1'], labType: 'filipenses' },
      ],
    },
    {
