...
const rawQuestions_L1: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Um único site onde as pessoas acessam páginas web.' },
      { id: 'c', text: 'Um programa instalado no computador para navegar em páginas.' },
      { id: 'd', text: 'Um cabo de fibra óptica que liga dois continentes.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'c', text: 'A Internet é um site; a WWW é o navegador.' },
      { id: 'd', text: 'A WWW é mais rápida que a Internet.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Porque cada usuário tem seu próprio servidor em casa.' },
      { id: 'c', text: 'Porque a Internet não usa servidores.' },
      { id: 'd', text: 'Porque apenas uma empresa controla toda a Internet.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Ele está certo, são a mesma coisa.' },
      { id: 'c', text: 'A Web é a infraestrutura; a Internet é um serviço.' },
      { id: 'd', text: 'Nenhum dos dois tem relação.' },
    ]},
  ...
  },
  {
    ...
    data: {
      blanks: [
        { id: 'b1', answer: 'roteador', hint: 'Dispositivo que conecta sua casa à Internet' },
        { id: 'b2', answer: 'ISP', hint: 'Empresa que fornece acesso à Internet (sigla de 3 letras)' },
        { id: 'b3', answer: 'pacotes', hint: 'Pequenos fragmentos de dados que viajam pela rede' },
      ],
    },
...
const rawQuestions_L2: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Enviar um arquivo do seu computador para a Internet.' },
      { id: 'c', text: 'Apagar um arquivo do computador.' },
      { id: 'd', text: 'Compartilhar um arquivo por e-mail.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Baixar um arquivo da Internet.' },
      { id: 'c', text: 'Formatar o disco rígido.' },
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Download — você está baixando a foto do Instagram.' },
      { id: 'c', text: 'Nenhum dos dois — a foto fica apenas no seu telefone.' },
      { id: 'd', text: 'Ambos simultaneamente, mas o upload não conta.' },
    ]},
  ...
  },
  {
    ...
    data: {
      blanks: [
        { id: 'b1', answer: 'servidor', hint: 'De onde vem o arquivo' },
        { id: 'b2', answer: 'computador', hint: 'Para onde vai o arquivo (ou dispositivo)' },
      ],
    },
...
const rawQuestions_L3: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Um programa antivírus.' },
      { id: 'c', text: 'Um tipo de vírus de computador.' },
      { id: 'd', text: 'Um cabo de rede.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Um tipo de site de busca.' },
      { id: 'c', text: 'Um programa de edição de imagens.' },
      { id: 'd', text: 'Um formato de compactação de arquivos.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Malware é um antivírus; vírus é o software malicioso.' },
      { id: 'c', text: 'São exatamente a mesma coisa.' },
      { id: 'd', text: 'Vírus afeta apenas e-mails; malware afeta apenas sites.' },
    ]},
  ...
  },
  {
    ...
    data: {
      blanks: [
        ...
        { id: 'b2', answer: 'webmail', hint: 'Acessar e-mail pelo navegador (ex: Gmail)' },
      ],
    },
...
const rawQuestions_2L1: Question[] = [
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'É mais rápido para enviar mensagens.' },
      { id: 'c', text: 'Não precisa de senha.' },
      { id: 'd', text: 'Compacta anexos automaticamente.' },
    ]},
  ...
  },
  {
    ...
    data: {
      blanks: [
        { id: 'b1', answer: 'remove', hint: 'O que POP3 faz com as mensagens após baixar' },
        { id: 'b2', answer: 'mantém', hint: 'O que IMAP faz com as mensagens (sinônimo de preservar)' },
      ],
    },
...
const rawQuestions_2L2: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Um dispositivo físico que conecta o computador à Internet.' },
      { id: 'c', text: 'Um protocolo de transferência de arquivos.' },
      { id: 'd', text: 'Um sistema de busca automática de vírus.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Baixar um arquivo completo antes de poder assistir.' },
      { id: 'c', text: 'Um tipo de vírus que afeta arquivos de mídia.' },
      { id: 'd', text: 'Um formato de compactação de imagens.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Um site que vende produtos online.' },
      { id: 'c', text: 'Um programa de e-mail.' },
      { id: 'd', text: 'Um antivírus.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Para acelerar a conexão com a Internet.' },
      { id: 'c', text: 'Para compactar arquivos e economizar espaço.' },
      { id: 'd', text: 'Para traduzir páginas automaticamente.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Enviar um e-mail para todos os amigos perguntando sobre Marte.' },
      { id: 'c', text: 'Baixar todos os sites da Internet e procurar manualmente.' },
      { id: 'd', text: 'Instalar um antivírus e esperar ele encontrar a informação.' },
    ]},
  ...
  },
  {
    ...
    data: {
      blanks: [
        { id: 'b1', answer: 'assinações', hint: 'Padrões que o antivírus usa para reconhecer vírus (sinônimo de assinaturas)' },
        { id: 'b2', answer: 'tempo real', hint: 'Tipo de proteção que monitora arquivos continuamente (2 palavras)' },
      ],
    },
...
const rawQuestions_3L1: Question[] = [
  {
    ...
    data: {
      items: [
        { id: 'a', text: 'Criação da ARPANET (1969)', order: 1 },
        { id: 'b', text: 'Adoção do TCP/IP (1983)', order: 2 },
        { id: 'c', text: 'Criação da WWW por Tim Berners-Lee (1989)', order: 3 },
        { id: 'd', text: 'Lançamento do Google (1998)', order: 4 },
        { id: 'e', text: 'Popularização das redes sociais (2004+)', order: 5 },
      ],
    },
    explanation: 'ARPANET → TCP/IP → WWW → Google → Redes sociais. Cada marco construiu sobre o anterior.',
  },
  {
    ...
    data: {
      blanks: [
        ...
        { id: 'b2', answer: 'Tim Berners-Lee', hint: 'Criador da World Wide Web' },
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Está correto, nasceram juntas em 1989.' },
      { id: 'c', text: 'A Web nasceu primeiro, em 1969, e a Internet em 1989.' },
      { id: 'd', text: 'Ambas foram criadas pelo Google em 1998.' },
    ]},
...
const rawQuestions_4L1: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Apenas navegando em sites seguros.' },
      { id: 'c', text: 'Desligando o computador à noite.' },
      { id: 'd', text: 'Usando senhas longas.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Para melhorar a velocidade da Internet.' },
      { id: 'c', text: 'Para liberar espaço no disco.' },
      { id: 'd', text: 'Para atualizar o navegador.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Desligando-se sozinho.' },
      { id: 'c', text: 'Formatando o disco rígido.' },
      { id: 'd', text: 'Aumentando o volume do som.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Apenas melhoria no desempenho.' },
      { id: 'c', text: 'Aumento da velocidade da Internet.' },
      { id: 'd', text: 'Nenhum prejuízo; vírus são inofensivos.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Clicar e digitar a senha, pois o e-mail parece oficial.' },
      { id: 'c', text: 'Responder com a senha por e-mail.' },
      { id: 'd', text: 'Encaminhar para amigos para que eles também verifiquem.' },
    ]},
  ...
  },
  {
    ...
    data: {
      blanks: [
        { id: 'b1', answer: 'antivírus', hint: 'Programa que protege contra malware' },
        { id: 'b2', answer: 'phishing', hint: 'Golpe que engana o usuário por e-mail ou site falso' },
        { id: 'b3', answer: 'atualização', hint: 'Ação essencial para que o antivírus reconheça novas ameaças' },
      ],
    },
