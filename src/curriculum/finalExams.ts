...
const rawAp034Final: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Um programa de navegação instalado no computador.' },
      { id: 'c', text: 'Um site específico de busca.' },
      { id: 'd', text: 'Um cabo submarino único que liga todos os continentes.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'O mesmo que a Internet, apenas com outro nome.' },
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'c', text: 'Apagar um arquivo permanentemente.' },
      { id: 'd', text: 'Comprimir um arquivo para ocupar menos espaço.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Termos sinônimos, sem qualquer distinção.' },
      { id: 'c', text: 'Malware protege; vírus ataca.' },
      { id: 'd', text: 'Vírus afeta apenas e-mail; malware apenas sites.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Baixar o arquivo completo antes de assistir.' },
      { id: 'c', text: 'Um tipo de vírus que afeta mídia.' },
      { id: 'd', text: 'Um formato de compactação de vídeo.' },
    ]},
  ...
  },
  {
    ...
    data: {
      scenarios: [
        ...
        { id: 'b', text: 'Clicar no link para verificar se a conta está realmente bloqueada.' },
        { id: 'c', text: 'Responder pedindo mais informações.' },
        { id: 'd', text: 'Encaminhar para todos os amigos para avisá-los.' },
      ],
    },
  ...
  },
  {
    ...
    data: {
      scenarios: [
        ...
        { id: 'b', text: 'Enviar o endereço completo, pois o amigo foi gentil.' },
        { id: 'c', text: 'Enviar apenas o telefone, não o endereço.' },
        { id: 'd', text: 'Marcar um encontro para receber o presente pessoalmente.' },
      ],
    },
  ...
  },
  {
    ...
    data: {
      scenarios: [
        ...
        { id: 'b', text: 'Baixar o antivírus do pop-up imediatamente para proteger o computador.' },
        { id: 'c', text: 'Clicar no pop-up para ver mais informações.' },
        { id: 'd', text: 'Compartilhar o link com amigos para que eles também se protejam.' },
      ],
    },
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Rápido, barato e moderno.' },
      { id: 'c', text: 'Popular, famoso e lucrativo.' },
      { id: 'd', text: 'Secreto, oculto e exclusivo.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Para acelerar a conexão de Internet.' },
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Baixar o antivírus do pop-up imediatamente.' },
      { id: 'c', text: 'Clicar no pop-up para ver mais informações.' },
      { id: 'd', text: 'Compartilhar o link com amigos.' },
    ]},
...
const rawAp035Final: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'd', text: 'Proteger contra vírus.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Maior velocidade.' },
      { id: 'c', text: 'Compressão de imagens.' },
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'c', text: 'PHP é para design; HTML é para lógica.' },
      { id: 'd', text: 'São a mesma linguagem.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'c', text: 'GIF é melhor para fotos; PNG para texto.' },
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'c', text: 'Sem compressão, arquivo grande.' },
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Um antivírus que remove vírus automaticamente.' },
      { id: 'c', text: 'Um cabo de rede de alta velocidade.' },
  ...
  },
  {
    ...
    data: {
      scenarios: [
        ...
        { id: 'b', text: 'Colocar todo o conteúdo em uma única página sem links.' },
        { id: 'c', text: 'Criar 4 páginas sem nenhum link entre elas.' },
        { id: 'd', text: 'Usar apenas imagens sem HTML.' },
      ],
    },
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Cliente e servidor são a mesma coisa.' },
      { id: 'c', text: 'Cliente é o hardware; servidor é o software.' },
      { id: 'd', text: 'Servidor é o usuário; cliente é a empresa.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Entregar exatamente como a IA gerou.' },
      { id: 'c', text: 'Não usar IA para nada.' },
      { id: 'd', text: 'Esconder que usou IA.' },
    ]},
