...
const rawQ_1L1: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Enviar mensagens de correio entre os servidores da rede.' },
      { id: 'c', text: 'Compactar os arquivos para que o download termine antes.' },
      { id: 'd', text: 'Proteger o computador contra vírus durante a navegação.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Maior velocidade de download, por usar uma via reservada.' },
      { id: 'c', text: 'Compressão automática das imagens antes de enviá-las.' },
      { id: 'd', text: 'Tradução das páginas para o idioma de quem acessa.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'c', text: 'Um protocolo que entrega e-mails entre servidores.' },
...
const rawQ_1L2: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'HTML é mais moderno e veio substituir o PHP nos sites atuais, por rodar direto no navegador sem precisar de servidor.' },
      { id: 'c', text: 'PHP cuida apenas da aparência da página, e HTML cuida da lógica e dos cálculos que ela precisa fazer.' },
      { id: 'd', text: 'São a mesma linguagem, com nomes distintos por razões históricas.' },
    ]},
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'No navegador, porque o próprio HTML compara a senha digitada com a que está guardada na página.' },
      { id: 'c', text: 'No roteador Wi-Fi, que examina tudo o que passa por ele antes de liberar o acesso.' },
      { id: 'd', text: 'No provedor de Internet, que intermedia todo o tráfego.' },
    ]},
...
const rawQ_1L5: Question[] = [
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'PNG aceita animação e o GIF não, e por isso o PNG acabou substituindo o GIF na web.' },
      { id: 'c', text: 'GIF é o formato indicado para fotografias, e PNG serve melhor para textos e desenhos com poucas cores.' },
      { id: 'd', text: 'Não há diferença prática entre os dois: ambos guardam a mesma imagem do mesmo jeito.' },
    ]},
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Guarda transparência e animação, do mesmo modo que o PNG e o GIF fazem.' },
      { id: 'c', text: 'Não aplica compressão alguma, e por isso gera arquivos bem grandes.' },
      { id: 'd', text: 'Trabalha com apenas 256 cores, o que o torna ruim para fotografias.' },
    ]},
...
const rawQ_6L1: Question[] = [
  ...
  },
  {
    ...
    data: { scenarios: [
      ...
      { id: 'b', text: 'Entregar exatamente como a ferramenta gerou, sem revisar nada.' },
      { id: 'c', text: 'Não usar inteligência artificial em nenhuma etapa do trabalho.' },
      { id: 'd', text: 'Esconder o uso da ferramenta, mesmo se alguém perguntar diretamente.' },
    ]},
...
const rawQ_graficos: Question[] = [
  ...
  },
  {
    ...
    data: { options: [
      ...
      { id: 'b', text: 'Porque o navegador ignora as imagens de tamanho reduzido.' },
      { id: 'c', text: 'Porque imagens pequenas demais não atravessam a rede inteira.' },
      { id: 'd', text: 'Porque o servidor prioriza o envio dos arquivos de nome mais curto.' },
    ]},
