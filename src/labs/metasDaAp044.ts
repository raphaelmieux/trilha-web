...
export const METAS_DA_AGENDA: MetaDaAgenda[] = [
  ...
  },
  {
    ...
    onde: 'No cabeçalho da coluna Nome, na seta ▾',
    passos: [
      'Clique na seta ▾ ao lado do nome da coluna Nome, na folha de dados.',
      'Escolha Classificar de A a Z.',
      'Dá no mesmo escolher a coluna — clicando no cabeçalho ou numa célula dela — e usar Classificar Crescente na faixa.',
