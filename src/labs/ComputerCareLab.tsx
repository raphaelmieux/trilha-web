...
const MESA: Objeto[] = [
  ...
  { id: 'm3', rotulo: 'Notebook sobre a mesa, e não sobre a cama', protege: true,
    porque: 'As saídas de ar do notebook ficam embaixo dele. Colchão e edredom tapam todas de uma vez.' },
