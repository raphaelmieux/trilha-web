...
export const PASSOS_DE_BLOCOS: Record<string, string[]> = {
  ...
  variavel: [
    ...
    'Os blocos de variável só aparecem depois que existe uma. Toque em "adicione ... a ..." para somar ao valor, ou em "mude ... para ..." para trocá-lo.',
  ...
  aparenciaOuSom: [
    ...
    'Em Som, "toque o som" conta um som tocado.',
  ...
  placar: [
    ...
    'Em Variáveis, toque em "adicione 1 a ...".',
  ...
  fimDeJogo: [
    ...
    'Dentro, ponha o que anuncia o fim: um "diga" e um "pare todos".',
  ],
};
